    ...
    return (
        ...
        <React.Fragment>
            ...
            <section className="event py-5 p-3 px-md-5 " id="events">
                ...
                >
                    100 minutes, 26 performers, 16 stories and 1 pandemic. Jason Robert Brown wrote the music
                ...
                <div className="event-item row my-5 py-0" id="1776">
                    ...
                    <div className="col-md-7 py-2">
                        ...
                        <p className="location">Performing at George DeMeester Performance Center at Reid Park (April)</p>
                        <p className="location">& St. Andrews Presbyterian Church (May)</p>
                        <p className="performance-date">April 24 & 25, 2020<br /> May 1 & 3, 2020</p>
                        <p className="alert alert-danger text-justify" role="alert">
                            Due to COVID-19, SAPAC's production of 1776 has been cancelled and will not be rescheduled.
                        </p>
                        <p>
                            Long before <strong><em>Hamilton</em></strong>, there was three-time Tony Award-winning
                        <em>1776</em> – the original American
                        ...
                        limited 4-performance run, you won’t want to miss our modern re-shaping (including nontraditional
                ...
                <div className="event-item row my-5 py-0" id="gutenberg_show">
                    ...
                    <div className="col-md-5 ml-0 pl-0 pt-3 my-0 ">
                        <img className=" my-0 py-0 img-fluid" src={Gutenberg}
                    ...
                    <div className="col-md-7 py-2">
                        ...
                        <p>Back by popular demand after being nominated for a <a
                            ...
                            target="_blank" rel="noreferrer">MAC Award</a> in 2018, this production of the hit
                        ...
                        Bud Davenport and Doug Simon (portrayed by real-life brothers <a
                                href="https://notthosewrightbrothers.com/" target="_blank" rel="noreferrer">Carson and Tyler Wright</a>) sing all
                        the
                        songs and play all the parts in their hilarious historical epic. Called “A smashing success” by the
                        New York Times, <span style={{ fontWeight: 'bold', fontStyle: 'italic' }}>Gutenberg! The Musical!</span>
                        went on to receive Lucille Lortel Award and Outer
                        Critics
                        Circle Award nominations for Outstanding Musical.</p>
                        <a href="http://www.notthosewrightbrothers.com" target="_blank" rel="noreferrer" className="btn btn-dark btn-lg">Show
                        Info</a>
                    </div>
                </div>
                ...
                <div className="event-item row my-5 py-0" id="title_of_show">
                    ...
                    <div className="col-md-5 ml-0 pl-0 pt-0 my-0 ">
                        <img className="my-0 py-0 img-fluid" src={TitleOfShowLogo} alt="[title of show]" />
                    </div>
                    <div className="col-md-7 py-2">
                        <h2 className="mt-0 pt-2" style={{ textTransform: "lowercase" }}>[title of show] (clean version)</h2>
                        <p className="byline">by Jeff Bowen and Hunter Bell</p>
                        <p className="location">Performing at Cabaret Theater, Temple of Music and Art</p>
                ...
                <div className="event-item row my-5 py-0" id="hot_mikado">
                    ...
                    <div className="col-md-5 ml-0 pl-0 py-0 my-0 ">
                        <img className=" my-0 py-0 img-fluid" src={HotMikadoLogo} alt="Winter Show" />
                    </div>
                    <div className="col-md-7 py-2">
                        <h2 className="mt-0 pt-2">Hot Mikado</h2>
                        <p className="byline">Adapted and arranged by David H. Bell and Rob Bowman</p>
                        ...
                        is spoken most fluently. <em><strong>Hot Mikado</strong></em> thrills by combining traditional
                        Japanese storytelling with the
