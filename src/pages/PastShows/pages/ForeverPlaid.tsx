      ...
      <section className="plaid py-5 p-3 px-md-5 container-fluid">
        ...
        <div className="row text-center">
          <div className="offset-sm-2 col-sm-8">
            <p>
              ...
              musicals in recent memory. This deliciously fun revue is
              chock-full of classic barbershop quartet harmonies and
              pitch-perfect melodies! Directed by Chach Snook who was on the
              National Tour of the show as well as Music Directed by Matthew
              Holter who is a founder of the doo-wop group The 4GENTS, this show
              will be sure to delight and move audiences!
            </p>
            <p>
              ...
              instantly. It is at the moment when their careers and lives end
              that the story of <em>Forever Plaid</em> begins....
            </p>
            <p>
              ...
              with overzealous precision, the &quot;Plaids&quot; are a
              guaranteed smash, with a program of beloved songs and delightful
              patter that keeps audiences rolling in the aisles when they&#39;re
              not humming along to some of the great nostalgic pop hits of the
              1950s.
            </p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="offset-lg-1 col-lg-10 ">
            <h2>Creative Team</h2>
            <Bio name="Chach Snook (Director) " image={chach_img}>
              Chach Snook lived in NYC as a professional singer/actor for almost
              10 years. As a member of the jazz a cappella group Pieces of 8, he
              recorded 2 albums. Chach performs many concerts in Arizona, some
              with wife, Jodi Darling. He has been seen singing with Khris Dodge
              Entertainment, The 4GENTS and other groups. Favorite productions:{" "}
              <em>Forever Plaid</em> (Jinx)-National Tour; Arizona Onstage
              Production of <em>Les Misérables</em>
              (Enjolras) with his daughter, Julia Darling Snook; St. Francis
              Theatre in the Foothills: Directed{" "}
              <em>A Christmas Survival Guide</em> and <em>Godspell 2012</em>;
              Directed and starred in successful runs of{" "}
              <em>I Love You, You’re Perfect, Now Change</em> (Man 1),
              <em>Triumph of Love</em> (Harlequin), and{" "}
              <em>The Last Five Years</em> (Jamie) with the Roadrunner Theatre
              Company (6 MAC Nominations); With Arts Express:{" "}
              <em>She Loves Me</em> (Sipos); he is the Music Director for the
              Monte Awards (Southern Arizona High School Musical Theatre Awards)
              and most recently <em>Sweeney Todd</em>
              (Sweeney Todd) again with his daughter. Chach has a Vocal
              Performance degree from NAU and is an award-winning Arts Educator.
              He currently is an Arts Integration Specialist with the Opening
              Minds Through the Arts (OMA) program for TUSD and for 12 years he
              was the Flowing Wells Jr. High School Choir and Drama teacher
              where he directed over 75 concerts, plays and musicals. Chach
              sends much love to his family (Jodi, Julia and Gabriel) and
              friends for their continued support.
            </Bio>
            <Bio name="Matthew Holter (Music Director)" image={matt_img}>
              is originally from the Fargo-Moorhead area and grew up with the
              music of the mid-20th Century all around. A widely recognized
              director and performer, his career has provided opportunities all
              over the world from China and Russia to performances throughout
              North America. Locally, Matthew maintains a very busy teaching and
              performing schedule. Mr. Holter is a Mentor Teacher for Choral
              teachers and a member of the Central Fine Arts Staff in TUSD
              teaching as an OMA specialist whose students have appeared
        ...
        <div className="row">
          <div className="offset-lg-1 col-lg-10 ">
            ...
            <Bio name="Ben Muckenthaler (FRANKIE)" image={ben_img}>
              ...
              auditioning for BFA programs and is helping run The Blank
              Conversations Theatre Company in Las Cruces, NM. Recent shows
              include <em>Sweeney Todd</em> as Anthony,{" "}
              <em>The Last Five Years</em> as Jaimie, and{" "}
              <em>Tuck Everlasting</em> as Miles. Ben was also a finalist in the
              2019 Monte Awards.
            </Bio>
          </div>
        </div>
